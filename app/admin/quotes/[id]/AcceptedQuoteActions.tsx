  ...
  return (
    <section className="rounded-2xl border border-emerald-200 bg-emerald-50 p-5 shadow-sm">
      ...
      <p className="mt-2 text-sm leading-6 text-emerald-900">
        Use the job pack for materials and ordering, or send the linked job straight to subcontractors without re-entering the details.
      </p>
      ...
      <div className="mt-3 text-xs font-bold text-emerald-800">Quote #{quoteId} remains the commercial source for this job.</div>
    </section>
  )
}
