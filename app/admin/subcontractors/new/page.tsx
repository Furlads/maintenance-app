    ...
    <div className="send-page">
      ...
      <div className="send-layout">
        <section className="send-card">
          ...
          <p className="send-copy">This is the admin side. Keep the first message deliberately vague enough to protect the customer, but useful enough for a contractor to decide whether they want to look at it.</p>
