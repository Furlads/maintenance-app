...
export default async function ContractorOpportunityPage({ params }: Props) {
  ...
  const rows = await prisma.$queryRaw<Row[]>`
    SELECT r."id" AS "recipientId", r."status", w."firstName", o."company", o."title", o."trade", o."roughArea",
      o."publicDescription", o."durationText", o."timingText", o."pricingMode", o."fixedPrice", o."quoteGuidance"
